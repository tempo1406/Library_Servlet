<%@page import="fu.edu.library.Models.User"%>
...
<html>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #23536f;">
                <a href="${pageContext.request.contextPath}/UserManual" class="brand-link"> <img
                        src="Resources/img/Logo.jpg" alt="AdminLTE Logo"
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column"
                            ...
                            <li
                                ...
                                <%
                                    if (request.getSession().getAttribute("User") != null) {
                                %>
                            <li class="nav-item" style="margin-top: 670px"><a
